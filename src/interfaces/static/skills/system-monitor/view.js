 ...
 *
 * Données RÉELLES (inchangées) via l'API L.Y.R.A :
    ...
    content.innerHTML = `
      ...
      <div class="sm-top">
        ...
        <div class="sm-card sm-brain" id="sm-panel-llm">
          <span class="sm-eyebrow">Cerveau L.Y.R.A · provider actif</span>
      ...
      <div class="sm-mid">
        <div class="sm-card sm-panel" id="sm-panel-services">
          <span class="sm-eyebrow">Services · écosystème L.Y.R.A</span>
          <div class="sm-rows">
      ...
      <div class="sm-bot">
        ...
        <div class="sm-card sm-cell">
          <span class="sm-cell-l">Processus L.Y.R.A</span>
