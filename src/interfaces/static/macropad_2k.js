/* macropad_2k.js — Macropad 2 touches Le Labo, integrated inside L.Y.R.A V4.
 * Vanilla JS port of the original React/Tauri studio.
 * Uses L.Y.R.A design system (mountSidebar, mountTopbar) + macropad_2k.css.
 */
(function () {
  "use strict";
  const J = window.Lyra;
